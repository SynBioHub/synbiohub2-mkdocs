...
The original version of SynBioHub can be found at [https://synbiohub.org](https://synbiohub.org).

### License

SynBioHub2 is released using the **[BSD-2-Clause License](https://github.com/SynBioHub/synbiohub3/blob/main/LICENSE.md)**.
